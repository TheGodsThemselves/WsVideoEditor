...
/**
 *
 * AudioTrack timestamp poller
 * Reference to:
 * https://github.com/google/ExoPlayer/blob/f7ed789fc3841b2536f5629c6bb10f4cb4ee5130/library/core/src/main/java/com/google/android/exoplayer2/audio/AudioTimestampPoller.java#L219
 */
...
final class AudioTimestampPoller {
  ...
  private static final int FAST_POLL_INTERVAL_US = 5_000; // 5ms
  /**
   * The polling interval for {@link #STATE_TIMESTAMP_ADVANCING} and {@link #STATE_NO_TIMESTAMP}.
   */
  private static final int SLOW_POLL_INTERVAL_US = 10_000_000; // 10s
  /** The polling interval for {@link #STATE_ERROR}. */
  private static final int ERROR_POLL_INTERVAL_US = 500_000; // 500ms
   ...
   */
  private static final int INITIALIZING_DURATION_US = 500_000; // 500ms
   ...
   * #getTimestampPositionFrames()}, and the caller should call acceptTimestamp() if the
   * timestamp was valid, or rejectTimestamp() otherwise. The values returned by
   * hasTimestamp() and isTimestampAdvancing() may be updated.
   *
  ...
  public void rejectTimestamp() {
    Log.i("AudioPlayByAudioTrack", "rejectTimestamp");
  ...
  public void acceptTimestamp() {
    if (state == STATE_ERROR) {
      Log.i("AudioPlayByAudioTrack", "acceptTimestamp but state == STATE_ERROR");
      reset();
    }
  }
  ...
  public long getTimestampSystemTimeUs() {
    return audioTimestamp != null ? audioTimestamp.getTimestampSystemTimeUs() : TIME_UNSET;
  }
  ...
  private void updateState(@State int state) {
    ...
    switch (state) {
      case STATE_INITIALIZING:
        ...
        initialTimestampPositionFrames = POSITION_UNSET;
  ...
  public long getTimestampPositionFrames() {
    return audioTimestamp != null ? audioTimestamp.getTimestampPositionFrames() : POSITION_UNSET;
  }

  /*
   * According to Android documents:
   * https://developer.android.com/reference/android/media/AudioTrack.html#getTimestamp(android.
   * media.AudioTimestamp)
   * We should poll audio timestamp with a regular interval
   */
  @TargetApi(19)
